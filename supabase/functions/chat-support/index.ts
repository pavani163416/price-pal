    ...
    const response = await fetch('https://ai.gateway.lovable.dev/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `You are a friendly and helpful customer support assistant for PriceCompare — an AI-powered price comparison platform that helps users find the best deals across Amazon, Flipkart, and Croma in India.
