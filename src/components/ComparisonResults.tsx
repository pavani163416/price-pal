...
const ComparisonResults = ({ products, query }: ComparisonResultsProps) => {
  ...
  return (
    <section className="container mx-auto px-4 py-10">
      ...
      {bestProduct && (
        <div className="mb-8 overflow-hidden rounded-2xl border-2 border-primary/30 bg-gradient-to-r from-primary/5 via-card to-primary/5 p-6 shadow-lg">
          <div className="flex flex-col items-center gap-6 sm:flex-row">
            {bestProduct.image ? (
              <div className="flex h-32 w-32 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-border bg-background p-2">
                <img
            ...
            <a
              ...
              className="shrink-0 rounded-xl bg-primary px-8 py-3 font-display text-sm font-semibold text-primary-foreground transition-colors hover:bg-primary/90"
            >
              Buy at Best Price
            </a>
          </div>
